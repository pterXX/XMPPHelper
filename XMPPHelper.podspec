...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/pterXX/XMPPHelper"
  ...
  s.source       = { :git => "https://github.com/pterXX/XMPPHelper.git", :tag => s.version.to_s }
  ...
  s.source_files  = "XMPPHelper/XMPPHelper/**/*.{h,m,swift}"
